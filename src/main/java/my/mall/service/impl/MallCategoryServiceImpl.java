...
import my.mall.api.mall.vo.SecondLevelCategoryVO;
import my.mall.api.mall.vo.ThirdLevelCategoryVO;
...
public class MallCategoryServiceImpl implements MallCategoryService {
    ...
    public List<MallIndexCategoryVO> getCategoriesForIndex() {
        ...
        for (int i = 0; i < firstLevelCategories.size(); i++) {
            System.out.println(firstLevelCategories.get(i).getCategoryName());
        }
