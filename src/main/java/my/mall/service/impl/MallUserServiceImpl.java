...
public class MallUserServiceImpl implements MallUserService {
    ...
    public String login(String loginName, String passwordMD5) {
        ...
        if (user != null) {
            ...
            if (mallUserToken == null) {
                ...
                System.out.println(mallUserToken.getUserId());
                System.out.println(mallUserToken.getToken());
                System.out.println(mallUserToken.getUpdateTime());
                System.out.println(mallUserToken.getExpireTime());
                //新增一条token数据
     ...
     */
    @Override
    public UserRole findUserRoleByUsername(String loginName) {
        return mallUserMapper.findUserRoleByUsername(loginName);
    }
    ...
    private String getNewToken(String timeStr, Long userId) {
        System.out.println(timeStr + " " + userId);
        String src = timeStr + userId + NumberUtil.genRandomNum(4);
        String str = "user";
        return SystemUtil.genToken(src,str);
    }
