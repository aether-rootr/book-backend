...
import my.mall.common.*;
import my.mall.dao.*;
import my.mall.entity.*;
...
public class MallOrderServiceImpl implements MallOrderService {
    ...
    @Override
    @Transactional
    public String saveOrder(User loginUser, MallUserAddress address, List<MallShoppingCartItemVO> myShoppingCartItems) {
